...
def search(manage_comb_value, result_tree):
...
def manage():
    ...
    search_btn = Button(manage_wd, text="搜索", width=11, command=lambda: search(manage_comb_value, result_tree),
                        relief=GROOVE)
    ...
    manage_comb.bind("<<ComboboxSelected>>", func)
